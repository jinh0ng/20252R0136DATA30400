...
# -*- coding: utf-8 -*-
"""
sagemaker-user@default:~/20252R0136DATA30400/src$ PYTHONPATH=.. python test_document_similarity.py   --data_dir /home/sagemaker-user/20252R0136DATA30400/project_release/Amazon_products   --model roberta-large-mnli   --batch_size 8   --max_len 256   --num_docs 3   --num_classes 12   --cache_dir ../outputs/stage1/sim_cache
"""
import argparse
import os
import time
